...
ALTER TABLE pacientes ADD(
    CONSTRAINT pac_ck_est_cli CHECK (estado_paciente IN ('A'/*Ambulatorio*/,'I'/*Interno*/))
);
...
ALTER TABLE intervenciones ADD (
    ...
    CONSTRAINT int_ck_tur_int CHECK (turno_intervencion IN ('M'/*Mañana*/,'T'/*Tarde*/, 'N'/*Noche*/))
);
